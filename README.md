...
**Melhorias futuras**: implementação de autenticação e autorização ; controle de acesso por níveis de permissão (admin e usuário); proteção de rotas administrativas; persistência de sessão com JWT;
